...
// import { selectGenerations, selectPokemons, selectTypes, selectVersions, selectMoves, selectMoveDamageClass, selectMachines, selectSpeciesById, selectChainDataByChainId, movesLoaded, machineDataLoaded, CachedMachine, CachedType, CachedVersion, CachedMove, CachedGeneration, CachedPokemon, CachedMoveDamageClass } from "./pokemonDataSlice";
...
// // language, types, versions, chainData, moves, machines, generations, speciesData, pokemons

// const Moves = memo<MovesProps>(function Moves({
// 	id,
// 	language,
// 	types,
// 	versionData,
...
// 	const movesToFetch = useMemo(() => pokemon.moves.filter(entry => !moveData[transformToKeyName(entry.move.name)]).map(entry => getIdFromURL(entry.move.url)), [pokemon, moveData]);
...
// 	// 	};
// 	// }, [moveData, dispatch, isMachineDataReady, movesLearnedByMachine, machines]);
