...
import { CachedGeneration, CachedPokemon, CachedPokemonSpecies, CachedType } from "../_components/pokemonData/pokemon-data-slice"
...
const PrerenderedPokemons = memo(function PrerenderedPokemons({types, generations, initialPokemonData = {}, initialSpeciesData = {}}: PrerenderedPokemonsProps) {
	...
	let intersection =  getIntersection2({query, type, gen, match}, generations, types, language as LanguageOption);
...
export default PrerenderedPokemons;
